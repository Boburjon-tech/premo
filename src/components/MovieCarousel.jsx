...
const MovieCarousel = () => {
  ...
  if (!data?.films?.length) return <p className="text-white px-4">Hech qanday film topilmadi.</p>;
  ...
  {/* Tugmalar faqat sm (≥640px) va undan yuqori ekranda ko‘rinadi */}
        ...
        <div className="relative overflow-hidden">
          <div
            ...
            style={{
              ...
              width: `${(movies.length * 100) / itemsPerView}%`,
            }}
          >
            {movies.map((movie) => (
              <div
